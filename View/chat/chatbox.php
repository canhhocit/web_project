<?php if (isset($currentChatId) && isset($thongTinChat)): ?>
    <div class="chatbox">
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <small class="text-muted">
                        Xe:
                        <a
                            href="/web_project/index.php?controller=car&action=detail&id=<?php echo $thongTinChat['idxe']; ?>">
        ...
        <form class="chatbox-input" id="formSendMessage" method="POST"
            ...
            <textarea name="noi_dung" id="messageInput" placeholder="Nhập tin nhắn..." rows="1" required></textarea>
