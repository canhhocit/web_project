...
<div class="container mt-4 pb-5">
    <h2 class="mb-4 text-primary fw-bold text-uppercase"><i class="fas fa-user-chart me-2"></i>Báo cáo doanh thu cá nhân</h2>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="card bg-primary text-white p-3 shadow-sm h-100">
                ...
                <i class="fas fa-money-bill-wave fa-3x stats-icon" style="opacity: 0.2; position: absolute; right: 15px; bottom: 10px;"></i>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card bg-success text-white p-3 shadow-sm h-100">
                ...
                <i class="fas fa-calendar-check fa-3x stats-icon" style="opacity: 0.2; position: absolute; right: 15px; bottom: 10px;"></i>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card bg-warning text-dark p-3 shadow-sm h-100">
                ...
                <i class="fas fa-car fa-3x stats-icon" style="opacity: 0.2; position: absolute; right: 15px; bottom: 10px;"></i>
            </div>
        </div>
    </div>
