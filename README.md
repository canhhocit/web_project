...
-   Phần thống kê (chỉ chủ xe dùng được)
    Thống kê doanh thu:

    -   Tổng doanh thu tích lũy: Tổng số tiền thu được từ tất cả các giao dịch hoàn tất.
    -   Doanh thu tháng hiện tại: Tự động lọc các giao dịch phát sinh trong tháng và năm hiện tại.
    -   Trình trạng xe: Xe đang thuê / tổng số xe
